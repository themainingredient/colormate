...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/b0d12ba2ded559c5d990fd0fc4959eca.html").path();
...
/* harmony import */ var _helpers_traverse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/traverse */ "./src/helpers/traverse.js");
/* harmony import */ var _helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/get-colors */ "./src/helpers/get-colors.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var colorsObject = {};
  var documentPages = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument().pages;
  var traversedPages = [];
  documentPages.forEach(function (page) {
    var traversedPage = Object(_helpers_traverse__WEBPACK_IMPORTED_MODULE_1__["traverse"])(page);
    traversedPages.push(traversedPage);
  });
  traversedPages.forEach(function (pageWithLayers) {
    pageWithLayers.forEach(function (layerWithParents) {
      var layer = layerWithParents.layer,
          parents = layerWithParents.parents;

      if ('style' in layer) {
        if (Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["hasBorder"])(layer)) {
          var color = layer.style.borders[0].color;
          var dataStructure = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["createDataStructure"])(layer, 'border', parents);
          colorsObject[color] = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["getColorArray"])(colorsObject, color, dataStructure);
        }

        if (Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["hasFill"])(layer)) {
          var _color = layer.style.fills[0].color;

          var _dataStructure = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["createDataStructure"])(layer, 'fill', parents);

          colorsObject[_color] = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["getColorArray"])(colorsObject, _color, _dataStructure);
        }

        if (Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["hasTextColor"])(layer)) {
          var _color2 = layer.style.textColor;

          var _dataStructure2 = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["createDataStructure"])(layer, 'text', parents);

          colorsObject[_color2] = Object(_helpers_get_colors__WEBPACK_IMPORTED_MODULE_2__["getColorArray"])(colorsObject, _color2, _dataStructure2);
        }
      }
    });
  });
  var orderedColorsObject = {};
  Object.keys(colorsObject).sort().reverse().forEach(function (key) {
...
/*!**********************************!*\
  !*** ./src/helpers/analytics.js ***!
  \**********************************/
/*! exports provided: track, trackAppStart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "track", function() { return track; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trackAppStart", function() { return trackAppStart; });
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_0__);
/* eslint-disable no-undef */

var kUUIDKey = 'google.analytics.uuid';
var uuid = sketch__WEBPACK_IMPORTED_MODULE_0__["Settings"].globalSettingForKey(kUUIDKey);

if (!uuid) {
  uuid = NSUUID.UUID().UUIDString();
  sketch__WEBPACK_IMPORTED_MODULE_0__["Settings"].setGlobalSettingForKey(uuid, kUUIDKey);
}
...
var track = function track(hitType, props) {
  if (!sketch__WEBPACK_IMPORTED_MODULE_0__["Settings"].globalSettingForKey('analyticsEnabled')) {
    // the user didn't enable sharing analytics
    return;
  }

  var TRACKING_ID = "UA-54328644-8";
  var payload = {
    v: 1,
    tid: TRACKING_ID,
    cid: uuid,
  ...
  var url = NSURL.URLWithString("https://www.google-analytics.com/collect?".concat(jsonToQueryString(payload)));
...
var trackAppStart = function trackAppStart() {
  track('event', {
    ec: 'application',
    ea: 'start'
  });
...
/***/ "./src/helpers/get-colors.js":
/*!***********************************!*\
  !*** ./src/helpers/get-colors.js ***!
  \***********************************/
/*! exports provided: getParents, hasBorder, hasFill, hasTextColor, createDataStructure, getColorArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getParents", function() { return getParents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasBorder", function() { return hasBorder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasFill", function() { return hasFill; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasTextColor", function() { return hasTextColor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDataStructure", function() { return createDataStructure; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getColorArray", function() { return getColorArray; });
...
var getParents = function getParents(parents, id) {
  return [].concat(_toConsumableArray(parents), [id]);
};
var hasBorder = function hasBorder(layer) {
  return !!layer.style.borders.length;
};
var hasFill = function hasFill(layer) {
  return !!layer.style.fills.length;
};
var hasTextColor = function hasTextColor(layer) {
  return !!layer.style.textColor;
};
var createDataStructure = function createDataStructure(layer, colorType, parents) {
  return {
    id: layer.id,
    colorType: colorType,
    parents: parents
...
var getColorArray = function getColorArray(colorsObject, color, dataStructure) {
  return colorsObject[color] ? [].concat(_toConsumableArray(colorsObject[color]), [dataStructure]) : [dataStructure];
};
...
/* harmony import */ var _get_colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./get-colors */ "./src/helpers/get-colors.js");

var traverse = function traverse(layer) {
  ...
  if ('layers' in layer && layer.layers.length) {
    layer.layers.forEach(function (subLayers) {
      return traverse(subLayers, layers, Object(_get_colors__WEBPACK_IMPORTED_MODULE_0__["getParents"])(parents, layer.id));
    });
  }

  var layerWithParents = {
    layer: layer,
    parents: parents
  };
...
/* harmony import */ var _helpers_analytics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/analytics */ "./src/helpers/analytics.js");
/* harmony import */ var _get_colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./get-colors */ "./src/get-colors.js");





var webview = __webpack_require__(/*! ../resources/webview.html */ "./resources/webview.html");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  webContents.on('getColors', function (s) {
    var colors = Object(_get_colors__WEBPACK_IMPORTED_MODULE_3__["default"])();
    sketch__WEBPACK_IMPORTED_MODULE_1__["UI"].message(s);
    webContents.executeJavaScript("sendUsedColors(".concat(JSON.stringify(colors), ")"))["catch"](console.error); // eslint-disable-line no-console
  });
  webContents.on('openUrlInBrowser', function (url) {
    NSWorkspace.sharedWorkspace().openURL(NSURL.URLWithString(url)); // eslint-disable-line no-undef
  });
  webContents.on('closeWindow', function () {
    browserWindow.close();
  });
  browserWindow.loadURL(webview);
  Object(_helpers_analytics__WEBPACK_IMPORTED_MODULE_2__["trackAppStart"])();
});
