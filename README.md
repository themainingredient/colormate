...
Download the latest [Colormate release](https://s3.eu-central-1.amazonaws.com/colormate-testing/production/colormate_1.3.0.zip).\_, unzip then double-click find-and-replace-text.sketchplugin to install.
